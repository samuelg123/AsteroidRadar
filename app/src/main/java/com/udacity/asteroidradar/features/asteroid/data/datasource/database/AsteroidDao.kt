package com.udacity.asteroidradar.features.asteroid.data.datasource.database
...
interface AsteroidDao {
    ...
    @Query("DELETE FROM asteroid WHERE DATE(closeApproachDate / 1000,'unixepoch') < DATE('now')")
